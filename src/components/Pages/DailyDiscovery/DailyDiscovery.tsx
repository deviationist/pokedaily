...
export function DailyDiscovery({ caughtList, onCatch }: DailyDiscoveryProps) {
  ...
  const { data: pokemon, isFetching } = useQuery(pokemonQueries.random())
  ...
  return (
    <div className="space-y-8 max-w-lg mx-auto py-4 px-4">
      <div className="flex flex-col items-center text-center space-y-2 mb-2">
        <p className="text-gray-500 text-sm">A wild Pokemon appeared! Will you add it to your collection?</p>
      </div>
            ...
            >
              <div className="flex flex-col gap-3 pt-2">
                <button
                  ...
                  disabled={isFetching}
                  className="w-full cursor-pointer flex items-center justify-center gap-2 py-4 bg-gray-100 text-gray-500 font-bold rounded-[2rem] hover:bg-gray-200 transition-all active:scale-[0.98] disabled:opacity-50 group shadow-sm"
                >
