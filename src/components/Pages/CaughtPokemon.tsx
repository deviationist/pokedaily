...
export function CaughtPokemon({ caughtList, onRelease }: CaughtPokemonProps) {
  return (
    <div className="max-w-4xl mx-auto py-6 px-4 space-y-8">
      <div className="flex items-end justify-between border-b border-gray-100 pb-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">My Collection</h1>
          <p className="text-gray-600" aria-live="polite">{caughtList.length} Pokemon Caught</p>
        </div>
      </div>
      ...
      {caughtList.length === 0 ? (
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <p className="text-gray-500 max-w-xs mx-auto">Go to the Discovery page to find and catch your first Pokemon.</p>
          </div>
        </motion.div>
      ) : (
