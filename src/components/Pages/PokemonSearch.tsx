  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4 px-4">
      <form onSubmit={handleSearch} className="relative group">
        ...
        <label htmlFor={id} className="sr-only">Search Pokémon by name</label>
        <Input
          id={id}
          type="text"
          value={query}
        ...
        <Button 
          ...
          variant="ghost"
          size={null}
          className="absolute cursor-pointer right-2 top-2 bottom-2 px-6 bg-red-500 text-white hover:text-white rounded-2xl font-bold hover:bg-red-600 shadow-lg active:scale-95 transition-all shadow-red-100"
        >
          Search
        </Button>
      </form>
        ...
        <AnimatePresence mode="wait">
          {error ? (
            ...
            >
              ...
              <p className="text-gray-500 font-medium italic">Enter a name to begin your search...</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
